...
@app.route('/')
def home():
    # Flask default 'templates/' folder mein index.html dhundhega
...
def generate_payment():
    try:
        ...
        upi_url = f"upi://pay?pa=shubhankar@oksbi&pn=SK%20TOURNAMENT&tn=Entry%20for%20UID%20{player_uid}&am=20&cu=INR"
